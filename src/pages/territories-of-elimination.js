...
const TerritoriesPage = () => {
    return (
        <Layout>
                ...
                <p>My intention with this series is to open space for reflection between chaos and tranquility. The project consists of ten 3D “territories” that bring my previous explorations in procedural design, minimalism, and geometric abstraction to a new digital medium. Each territory plays in an endless loop and is accompanied by audio produced via generative processes.</p>
                <p>I regard each territory as a psychic palette cleanser. Visual loops have the power to manifest a certainty that provides safety and freedom for the mind to wander. To pair this certainty with malleable audio that shifts and reconstructs itself from one second to the next has an intentionally distracting and meditative effect. It’s a contradiction that slows thought: the titular “elimination.” The elimination of disorder. The possibility that arises from stillness.</p>
