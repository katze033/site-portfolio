...
const ProjectsWebPage = () => {
    ...
    query {
        questForCute: file(relativePath: { eq: "web/quest-for-cute.png" }) {
        ...fitImage
        }
    }
    `)
            ...
            <div>
                ...
                <div className={categoriesStyles.webImages_container}>
                    <a href="https://zealous-engelbart-509321.netlify.com/">
                        <Img
                            fluid={data.questForCute.childImageSharp.fluid}
                            alt="An online storefront for an Etsy gift shop. Colorful pencil case."
