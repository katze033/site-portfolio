    ...
    return (
        <Layout>
            <div>
                ...
                <a href="https://zealous-engelbart-509321.netlify.com/"><img src={`/quest-for-cute.png`} alt="A site designed for Quest For Cute, an online gift shop." className={categoriesStyles.images}></img></a>
                </div>
